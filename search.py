...
def uniformCostSearch(problem):
    ...
    while not priQueue.isEmpty():
        (position, path, cost) = priQueue.pop()
        if problem.isGoalState(position):
            result = path
            break
        ...
        if position not in visited:
            ...
            for successor in successors:
                ...
                priQueue.push((successor[0], newPath, newCost), newCost)
    ...
    while not priQueue.isEmpty():
        ...
        if position not in visited:
            ...
            for successor in successors:
                newPath = path + [successor[1]]
                newCost = cost + successor[2]
                priQueue.push((successor[0], newPath, newCost), newCost + heuristic(successor[0], problem))
